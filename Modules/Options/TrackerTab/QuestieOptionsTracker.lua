                    ...
                    group_header = {
                        ...
                        args = {
                            ...
                            hideZoneHeaders = {
                                ...
                                desc = function() return l10n("When enabled, zone headers like 'Trade District', '[EpochDB Missing]', '[EpochDB Partial]', and 'Quests (By Level)' will be hidden, showing only quest titles and objectives in a flat list.") end,
                                disabled = function() return not Questie.db.profile.trackerEnabled end,
