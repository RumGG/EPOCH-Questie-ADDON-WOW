...
local advancedOptionsLocales = {
    ...
    ["Questie is under active development for Project Epoch! Please check Discord or Github for latest info! (https://github.com/trav346/Questie)"] = {
        ["ptBR"] = "Questie is under active development for Project Epoch! Please check Discord or Github for latest info! (https://github.com/trav346/Questie)",
        ["ruRU"] = "Questie is under active development for Project Epoch! Please check Discord or Github for latest info! (https://github.com/trav346/Questie)",
        ["deDE"] = "Questie is under active development for Project Epoch! Please check Discord or Github for latest info! (https://github.com/trav346/Questie)",
        ["koKR"] = "Questie is under active development for Project Epoch! Please check Discord or Github for latest info! (https://github.com/trav346/Questie)",
        ["esMX"] = "Questie is under active development for Project Epoch! Please check Discord or Github for latest info! (https://github.com/trav346/Questie)",
        ["enUS"] = true,
        ["zhCN"] = "Questie is under active development for Project Epoch! Please check Discord or Github for latest info! (https://github.com/trav346/Questie)",
        ["zhTW"] = "Questie is under active development for Project Epoch! Please check Discord or Github for latest info! (https://github.com/trav346/Questie)",
        ["esES"] = "Questie is under active development for Project Epoch! Please check Discord or Github for latest info! (https://github.com/trav346/Questie)",
        ["frFR"] = "Questie is under active development for Project Epoch! Please check Discord or Github for latest info! (https://github.com/trav346/Questie)",
    },
    ["Skip Validation"] = {
