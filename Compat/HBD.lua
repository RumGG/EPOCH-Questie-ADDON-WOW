...
local function UpdateWorldMap()
    ...
    -- Get map dimensions directly without conditional scaling
    -- Testing shows WorldMapButton:GetWidth() always returns 1002 in both modes
    -- so the previous conditional logic was unnecessary (Issue #39)
